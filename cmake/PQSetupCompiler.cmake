...
OPTION(WITH_UBSAN "Turn ON Undefined behaviour sanitizer feature" OFF)
...
#
  ...
  MESSAGE(STATUS "<DEVELOPER MODE> -> WITH_UBSAN=${WITH_UBSAN}")
...
IF(WITH_UBSAN)
  ...
  CHECK_C_COMPILER_FLAG("" UBSAN_C_OK)
  CHECK_CXX_COMPILER_FLAG("" UBSAN_CXX_OK)
  IF(UBSAN_C_OK AND UBSAN_CXX_OK)
